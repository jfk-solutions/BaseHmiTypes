...
export interface HmiDefaultProperty<T> extends HmiProperty<T> {
  readonly kind: HmiPropertyKind.Default;
  profileName?: string;
  propertyName?: string;
}
...
export function defaultProperty<T>(value?: T, profileName?: string, propertyName?: string): HmiDefaultProperty<T> {
